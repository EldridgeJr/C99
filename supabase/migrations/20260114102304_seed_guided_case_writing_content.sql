/*
  ...
  This creates a structured framework for clients to document their case.
  ...
  2. Sample Prompts
    - Multiple writing prompts for each section
    - Includes helper text and word limits
*/

-- Insert case writing sections
...
-- Get section IDs for inserting prompts
DO $$
DECLARE
...
BEGIN
  ...
  -- Insert prompts for "Your Story" section
  ...
  -- Insert prompts for "Key Facts" section
  INSERT INTO case_writing_prompts (section_id, question, helper_text, order_index, word_limit) VALUES
  ...
  -- Insert prompts for "Your Position" section
  INSERT INTO case_writing_prompts (section_id, question, helper_text, order_index, word_limit) VALUES
  ...
  -- Insert prompts for "Supporting Evidence" section
  INSERT INTO case_writing_prompts (section_id, question, helper_text, order_index, word_limit) VALUES
  ...
  -- Insert prompts for "Timeline" section
  INSERT INTO case_writing_prompts (section_id, question, helper_text, order_index, word_limit) VALUES
  ...
  -- Insert prompts for "Concerns & Questions" section
  INSERT INTO case_writing_prompts (section_id, question, helper_text, order_index, word_limit) VALUES
